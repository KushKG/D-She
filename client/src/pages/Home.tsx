...
const Home = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-8 pt-8 pb-20">
      <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold tracking-wide text-earth-800 mb-8 sm:mb-12 text-center font-proxima uppercase letter-spacing-wider">
      ...
      {isLoading ? (
        ...
        <div className="text-center text-earth-500 font-proxima text-base sm:text-lg">No favorites yet. Check back soon!</div>
      ) : (
